            ...
            <form action="/admin/siswa" method="POST" class="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
                ...
                <div>
                    ...
                    <select name="kelas" required
                        ...
                        <option value="TK A">TK A - Kelompok 1</option>
                        <option value="TK A">TK A - Kelompok 2</option>
                        <option value="TK B">TK B - Kelompok 1</option>
                        <option value="TK B">TK B - Kelompok 2</option>
